...
public class InputConstractServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ConstractErrorMsg constractErrorMsg = new ConstractInputCheck().checkError(workplace, start_time, end_time, break_time);
		if(constractErrorMsg.getWorkplace_errorMsg() != null || constractErrorMsg.getStart_time_errorMsg() != null || constractErrorMsg.getEnd_time_errorMsg() != null || constractErrorMsg.getBreak_time_errorMsg() != null) {
